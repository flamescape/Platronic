...
var GridGraphicsComponent = function(params){
    ...
    this.material.diffuseTexture = new BABYLON.Texture("img/grid_diffuse.png", ServiceLocator.get('scene'));
    this.material.emissiveTexture = new BABYLON.Texture("img/grid_emiss.png", ServiceLocator.get('scene'));
    this.material.specularPower = 10;
    this.material.specularTexture = new BABYLON.Texture("img/grid_spec.png", ServiceLocator.get('scene'));
    ...
    this.material.bumpTexture = new BABYLON.Texture("img/grid_normal.png", ServiceLocator.get('scene'));
